...
\DeclareFontShape{LMP2}{mtt}{m}{n}{%
  ...
  <9-> s*[\mtpscale] mt2syt}{%
  \fontdimen20\font=\dimexpr\fontdimen6\font*119/50\relax}
...
% So a straightforward comparison is possible.
...
% So we need to use a different test.
\newcommand*\@ifcurlybraces{%
...
\newcommand\subalign[1]{%
  \vcenter{%
    ...
    \ialign{%
      &\hfil$\m@th\scriptstyle##$&$\m@th\scriptstyle{}##$\hfil\crcr
      #1\crcr
    }%
  }%
}
\AtBeginDocument{%
  ...
  \patchcmd\reset@strutbox@
    {\copy\strutbox}
    {\hbox{\vrule\@height\dimexpr(\baselineskip
